...
First, you'll need an API key. You can get one from your [settings page](https://app.olyptik.io/settings/crawl). Include it in your requests using the Authorization header:
...
Configure a webhook URL in your [settings page](https://app.olyptik.io/settings/crawl) to receive real-time status updates. You can choose from two notification types:
