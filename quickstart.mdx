...
First, you'll need an API key. You can get one from your [settings page](https://app.olyptik.com/0/settings/crawl). Include it in your requests using the Authorization header:
...
Configure a webhook URL in your [settings page](https://app.olyptik.com/0/settings/crawl) to receive real-time status updates. You can choose from two notification types:
...
```bash curl
curl https://api.olyptik.com/v1/crawls/{crawl_id}/results?page=1&limit=50 \
  -H "Authorization: Bearer your-api-key"
```
