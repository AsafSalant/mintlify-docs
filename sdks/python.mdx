---
title: "Python SDK"
description: "The Olyptik Python SDK provides a simple and intuitive interface for web crawling and content extraction. It supports both synchronous and asynchronous programming patterns with full type hints."
---
...
First, you'll need to initialize the SDK with your API key - you can get it from the [settings page](https://app.olyptik.io/settings/project). You can either pass it directly or use environment variables.
...
- 📧 Email: [support@olyptik.io](mailto:support@olyptik.io)
