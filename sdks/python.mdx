---
title: "Python SDK"
description: "Get started with the Olyptik Python SDK for web crawling and content extraction"
---
...
| maxDepth           | number  | ❌ (conditional - must be provided with "maxResults")                                   | 10      | Maximum depth of pages to crawl (1-100)                                                 |
