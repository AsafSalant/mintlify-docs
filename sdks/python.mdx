...
First, you'll need to initialize the SDK with your API key - you can get it from the [settings page](https://app.olyptik.io/0/settings/crawl). You can either pass it directly or use environment variables.
...
| timeout | number | ❌ | 60 | Timeout duration in minutes (minimum: 60) |
...
from olyptik import Olyptik
client = Olyptik()  # Reads from environment

# ❌ Avoid: Hardcoding API keys
client = Olyptik(api_key="hardcoded_key")
```
